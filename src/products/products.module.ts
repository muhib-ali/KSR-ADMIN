...
@NestModule({
  imports: [
    TypeOrmModule.forFeature([Product, ProductImage, Category, Brand, Variant, VariantType, CvgProduct, BulkPrice, CustomerVisibilityGroup, Tax, Supplier, Warehouse, Subcategory]),
